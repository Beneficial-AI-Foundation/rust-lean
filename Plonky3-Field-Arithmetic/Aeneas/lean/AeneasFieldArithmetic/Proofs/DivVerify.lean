...
theorem div_verify_to_spec
  ...
  rw [mul_verify_to_spec n inv valid_n h_valid_inv,
      inverse_to_spec m inv valid_m nonzero_m h_inv_ok, div_eq_mul_inv]
